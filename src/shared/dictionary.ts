...
const EN = {
  ...
  'set.title': 'Settings',
  'set.rooms': 'What this room has in it',
  'set.table': 'The table',
  'set.yours': 'Yours, on this device',
  'remind.off': 'Tell me when the table opens',
  'remind.on': 'Telling you when the table opens',
  'remind.needs_install': 'Add dads to your home screen and you can be told when the table opens.',
  ...
  'here.nobody': 'Nobody, right now.',
  'here.comings': 'Coming and going',
  'here.nothing': 'Nothing yet.',
  'here.failed': 'Couldn’t load that.',
  'here.you': ' (you)',
  ...
  // -------------------------------------------------------- the questions
  'q.title': 'Questions',
  'q.nobody_answered': 'Nobody has answered yet.',
  'q.answers_one': '1 answer.',
  'q.answers_other': '{n} answers.',
  'q.you_answered': 'You’ve answered.',
  'q.answer': 'Answer',
  'q.say_more': 'Say more',
  'q.your_answer': 'Your answer',
  'q.take_your_time': 'Take your time.',
  'q.not_now': 'Not now',
  'q.asked_before': 'Asked before',
  'q.first_tomorrow': 'Nothing yet. The first question lands tomorrow.',
  'q.add': 'Add a question',
  'q.add_label': 'A question for the group',
  'q.add_placeholder': 'Ask the others something',
  'q.add_button': 'Add',
  'q.by': 'by {name}',
  'q.yours': 'yours',
  'q.n_answers_one': '1 answer',
  'q.n_answers_other': '{n} answers',
  'q.loading': 'Fetching the list…',
  'q.failed': 'Couldn’t load the questions.',
  ...
  // ---------------------------------------------------------- the week
  'b.title': 'The week',
  'b.loading': 'Fetching the board…',
  'b.failed': 'Couldn’t load the board.',
  'b.this_week': 'This week',
  'b.how_was': 'How was your week?',
  'b.note_label': 'One line about your week',
  'b.note_placeholder': 'One line — the honest version',
  'b.commit_label': 'One thing to try this week',
  'b.commit_placeholder': 'Something small and concrete',
  'b.save': 'Save',
  'b.nothing_yet': '— nothing yet',
  'b.trying': 'trying',
  'b.kept': 'kept',
  'b.missed': 'missed',
...
const FR: Record<Key, string> = {
  ...
  'set.title': 'Réglages',
  'set.rooms': 'Ce qu’il y a dans cette salle',
  'set.table': 'La table',
  'set.yours': 'À toi, sur cet appareil',
  'remind.off': 'Avertis-moi quand la table ouvre',
  'remind.on': 'Tu seras averti quand la table ouvre',
  'remind.needs_install':
    'Ajoute dads à ton écran d’accueil et tu pourras être averti quand la table ouvre.',
  ...
  'here.nobody': 'Personne, là.',
  'here.comings': 'Les allées et venues',
  ...
  'q.nobody_answered': 'Personne n’a répondu encore.',
  ...
  'q.asked_before': 'Déjà demandé',
  'q.first_tomorrow': 'Rien encore. La première question arrive demain.',
  'q.add': 'Ajoute une question',
  'q.add_label': 'Une question pour le groupe',
  'q.add_placeholder': 'Demande quelque chose aux autres',
  'q.add_button': 'Ajoute',
  'q.by': 'de {name}',
  'q.yours': 'la tienne',
  'q.n_answers_one': '1 réponse',
  'q.n_answers_other': '{n} réponses',
  'q.loading': 'Je charge la liste…',
  'q.failed': 'Les questions n’ont pas chargé.',
  ...
  // ------------------------------------------------------------ la semaine
  'b.title': 'La semaine',
  'b.loading': 'Je charge le tableau…',
  'b.failed': 'Le tableau n’a pas chargé.',
  'b.this_week': 'Cette semaine',
  'b.how_was': 'C’était comment, ta semaine?',
  'b.note_label': 'Une ligne sur ta semaine',
  'b.note_placeholder': 'Une ligne — la vraie version',
  'b.commit_label': 'Une affaire à essayer cette semaine',
  'b.commit_placeholder': 'Quelque chose de petit et de concret',
  'b.save': 'Enregistre',
  'b.nothing_yet': '— rien encore',
  'b.trying': 'essaie',
  'b.kept': 'fait',
  'b.missed': 'manqué',
  ...
  't.own_tab': 'Ouvre-la dans un autre onglet ↗',
