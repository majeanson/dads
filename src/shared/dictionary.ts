...
const EN = {
  ...
  'inv.lede': 'Send him this. It opens the door for a week.',
  ...
  'n.agenda_empty': 'Nothing up yet. Put the thing you keep meaning to ask.',
  ...
  'sys.item_added': '{name} put something up for dad night: {body}',
...
const FR: Record<Key, string> = {
  ...
  'inv.lede': 'Envoie-lui ça. Ça ouvre la porte pendant une semaine.',
  'inv.link': 'Le lien',
  'inv.copy': 'Copie',
  'inv.copied': 'Copié',
  'inv.share': 'Partage',
  ...
  'n.agenda_empty': 'Rien encore. Mets l’affaire que t’oublies chaque fois.',
  ...
  'sys.item_added': '{name} a mis une affaire pour la soirée : {body}',
