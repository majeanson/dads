...
const EN = {
  ...
  'set.yours_to_change': 'Yours to change — you opened this room.',
  'set.table': 'The table',
...
const FR: Record<Key, string> = {
  ...
  'set.yours_to_change': 'À toi de changer — c’est toi qui as ouvert le salon.',
  'set.table': 'La table',
  ...
  'fit.size': 'Taille',
  'fit.reset': 'Remets-les au milieu',
  'fit.save': 'Enregistre',
