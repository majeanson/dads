...
const EN = {
  ...
  // Opening a room of your own.
  'new.start': 'Start a room',
  'new.title': 'Your own room',
  'new.lede': 'Name it, pick a word, and send the word to the others.',
  'new.room_name': 'What to call it',
  'new.word': 'The word to get in',
  'new.word_hint': 'Anyone with this word can come in. Four letters or more.',
  'new.your_name': 'Your name',
  'new.open': 'Open the room',
  'new.opening': 'Opening…',
  'new.back': 'I have a word already',
  'new.missing_room_name': 'Give the room a name.',
  'new.room_name_too_long': 'That’s a long name — 40 characters or fewer.',
  'new.code_too_short': 'That word is too short — four letters or more.',
  ...
  'composer.edit_failed': 'The change didn’t reach the room. Your words are still here.',
  'composer.emoji': 'Add an emoji',
  'composer.replying': 'Replying to {name}',
  'composer.editing': 'Changing what you said',
  'composer.clear': 'Never mind',
  ...
  'voice.play': 'Play the voice note',
  'voice.pause': 'Pause',
  'line.more_marks': 'More marks',
  ...
  'menu.rooms': 'Your rooms',
  'rooms.title': 'Your rooms',
  'rooms.lede': 'Every room this phone is in. Tap one to go there.',
  'rooms.here': 'you’re here',
  'rooms.as': 'as {name}',
  'rooms.going': 'Going…',
  'rooms.failed': 'Couldn’t switch. Try again.',
  'rooms.another': 'Join another room',
  'rooms.another_hint': 'You keep this one either way.',
  'rooms.word': 'Its word',
  'rooms.join': 'Join it',
  'rooms.joining': 'Going in…',
  'rooms.bad_word': 'That word doesn’t open anything.',
  'rooms.start': 'Start a room of your own',
  ...
  'inv.copied': 'Copied',
  'inv.share': 'Share',
  'inv.preview_night': 'You’re invited. Dad night: {when}.',
  'inv.preview_plain': 'You’re invited. Come in and say hi.',
  ...
  'set.owner': '{name} opened this room, so these are his to change.',
  'set.word': 'The word to get in',
  'set.word_hint':
    'Nobody can be shown the current one — it is kept as a hash. Setting a new one stops the old one working, and kills any invite links you have sent.',
  'set.word_new': 'A new word',
  'set.word_save': 'Change it',
  'set.word_done': 'Changed. Send the new one to the others.',
  'set.word_short': 'That word is too short — four letters or more.',
  'set.word_long': 'That word is too long.',
  'set.word_taken': 'Another room already uses that word.',
  'set.word_failed': 'Couldn’t change it. Try again.',
  'set.owning': 'The word, and handing it on',
  'set.hand_over': 'Hand the room over',
  'set.hand_hint':
    'He gets the switches and the word. You can’t take it back — only he can hand it on.',
  'set.hand_who': 'To which dad',
  'set.hand_do': 'Hand it over',
  'set.hand_sure': 'Yes, hand it to {name}',
  'set.hand_failed': 'That didn’t work. Try again.',
  'set.table': 'The table',
  'set.yours': 'On this device',
  'you.title': 'You',
  'you.glasses': 'Your glasses',
  'you.glasses_failed': 'Couldn’t put those on. Try again.',
  'fit.open': 'Fit them on your photo',
  'fit.title': 'Put them on your eyes',
  'fit.area': 'Your glasses on your photo. Drag them, or move them with the arrow keys.',
  'fit.size': 'Size',
  'fit.reset': 'Centre them',
  'fit.save': 'Save',
  'fit.failed': 'Couldn’t save that. Try again.',
  'glasses.shades': 'Shades',
  'glasses.aviators': 'Aviators',
  'glasses.round': 'Round',
  'glasses.square': 'Square frames',
  'glasses.3d': '3D glasses',
  'glasses.goggles': 'Ski goggles',
  'you.name': 'Your name',
  'you.save': 'Save',
  ...
  'here.you': ' (you)',
  'here.champion': ', who won the last game',
  ...
  't.new': 'New table',
  't.new_sure': 'Clear it for everyone?',
  't.new_failed': 'Couldn’t set a new table.',
  ...
  'n.call_off_sure': 'Yes, call it off',
  'n.call_off_hint': 'It comes off the calendar and the group picks another.',
  'n.time': 'Time',
  'n.save': 'Save',
  'n.clear': 'Clear',
  ...
  'sys.night_off': '{by} called off {when}. When’s the next one?',
  'sys.word_changed': '{by} changed the word to get in. The old one has stopped working.',
  'sys.room_handed': '{by} handed the room to {to}.',
  ...
  'sys.night_tried_one': 'one thing being tried this week',
  'sys.night_tried_other': '{n} things being tried this week',
  'sys.night_kept': 'last week {kept} of {total} kept',
...
const FR: Record<Key, string> = {
  ...
  'new.start': 'Pars un salon',
  'new.title': 'Ton salon à toi',
  'new.lede': 'Donne-lui un nom, choisis un mot, pis envoie le mot aux autres.',
  'new.room_name': 'Comment l’appeler',
  'new.word': 'Le mot pour entrer',
  'new.word_hint': 'N’importe qui avec ce mot peut entrer. Quatre lettres ou plus.',
  'new.your_name': 'Ton nom',
  'new.open': 'Ouvre le salon',
  'new.opening': 'J’ouvre…',
  'new.back': 'J’ai déjà un mot',
  'new.missing_room_name': 'Donne un nom au salon.',
  'new.room_name_too_long': 'C’est long — 40 caractères maximum.',
  'new.code_too_short': 'Ce mot est trop court — quatre lettres ou plus.',
  ...
  'composer.edit_failed': 'Le changement s’est pas rendu. Tes mots sont encore là.',
  'composer.emoji': 'Ajoute un emoji',
  'composer.replying': 'En réponse à {name}',
  'composer.editing': 'Tu modifies ce que t’as dit',
  'composer.clear': 'Laisse faire',
  ...
  'voice.play': 'Écoute la note vocale',
  'voice.pause': 'Mets sur pause',
  'line.more_marks': 'Plus de marques',
  ...
  'menu.rooms': 'Tes salons',
  'rooms.title': 'Tes salons',
  'rooms.lede': 'Tous les salons où ce téléphone est. Touche-en un pour y aller.',
  'rooms.here': 't’es ici',
  'rooms.as': 'comme {name}',
  'rooms.going': 'J’y vais…',
  'rooms.failed': 'Le changement a pas marché. Réessaie.',
  'rooms.another': 'Joins un autre salon',
  'rooms.another_hint': 'Tu gardes celui-ci dans les deux cas.',
  'rooms.word': 'Son mot',
  'rooms.join': 'Entre',
  'rooms.joining': 'J’entre…',
  'rooms.bad_word': 'Ce mot ouvre rien.',
  'rooms.start': 'Pars ton propre salon',
  ...
  'inv.copied': 'Copié',
  'inv.share': 'Partage',
  'inv.preview_night': 'T’es invité. Soirée de gars : {when}.',
  'inv.preview_plain': 'T’es invité. Rentre dire allô.',
  ...
  'set.owner': '{name} a ouvert ce salon, c’est à lui de changer ça.',
  'set.word': 'Le mot pour entrer',
  'set.word_hint':
    'Personne peut voir celui d’avant — il est gardé haché. En mettre un nouveau arrête l’ancien, pis tue les liens d’invitation que t’as envoyés.',
  'set.word_new': 'Un nouveau mot',
  'set.word_save': 'Change-le',
  'set.word_done': 'Changé. Envoie le nouveau aux autres.',
  'set.word_short': 'Ce mot est trop court — quatre lettres ou plus.',
  'set.word_long': 'Ce mot est trop long.',
  'set.word_taken': 'Un autre salon utilise déjà ce mot.',
  'set.word_failed': 'Ça n’a pas changé. Réessaie.',
  'set.owning': 'Le mot, et le passer',
  'set.hand_over': 'Passe le salon',
  'set.hand_hint':
    'Il aura les interrupteurs pis le mot. Tu peux pas le reprendre — juste lui peut le repasser.',
  'set.hand_who': 'À quel gars',
  'set.hand_do': 'Passe-lui',
  'set.hand_sure': 'Oui, passe-le à {name}',
  'set.hand_failed': 'Ça a pas marché. Réessaie.',
  'set.table': 'La table',
  'set.yours': 'Sur cet appareil',
  'you.title': 'Toi',
  'you.glasses': 'Tes lunettes',
  'you.glasses_failed': 'Pas pu les mettre. Réessaie.',
  'fit.open': 'Ajuste-les sur ta photo',
  'fit.title': 'Mets-les sur tes yeux',
  'fit.area': 'Tes lunettes sur ta photo. Glisse-les, ou bouge-les avec les flèches.',
  'fit.size': 'Taille',
  'fit.reset': 'Recentre-les',
  'fit.save': 'Enregistre',
  'fit.failed': 'Pas pu enregistrer. Réessaie.',
  'glasses.shades': 'Verres fumés',
  'glasses.aviators': 'Aviateur',
  'glasses.round': 'Rondes',
  'glasses.square': 'Montures carrées',
  'glasses.3d': 'Lunettes 3D',
  ...
  'here.you': ' (toi)',
  'here.champion': ', qui a gagné la dernière partie',
  ...
  't.new': 'Nouvelle table',
  't.new_sure': 'On vide pour tout le monde?',
  't.new_failed': 'Pas pu dresser une nouvelle table.',
  ...
  'n.call_off_sure': 'Oui, annule-la',
  'n.call_off_hint': 'Elle sort du calendrier pis le groupe en choisit une autre.',
  'n.time': 'Heure',
  'n.save': 'Enregistre',
  'n.clear': 'Efface',
  ...
  'sys.night_off': '{by} a annulé {when}. C’est quand la prochaine?',
  'sys.word_changed': '{by} a changé le mot pour entrer. L’ancien marche plus.',
  'sys.room_handed': '{by} a passé le salon à {to}.',
  ...
  'sys.night_tried_one': 'une affaire à l’essai cette semaine',
  'sys.night_tried_other': '{n} affaires à l’essai cette semaine',
  'sys.night_kept': 'la semaine passée {kept} sur {total} de faites',
