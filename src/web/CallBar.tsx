...
/**
 * The way into the call, for the conversation's header.
 *
 * Also where the microphone's refusals are said, because that is where the
 * dad just pressed something and is owed an answer. A plain 44px square with
 * the words for a screen reader only: the bar it sits in is one slim row.
 */
