/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: a4ffd2e8bafde72faf9122521d3d1167)
...
interface __BaseEnv_Env {
  ...
  ENVIRONMENT: string;
  OPEN_DOOR: string;
  ROOM: DurableObjectNamespace<import('./src/worker/index').RoomDO>;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'ENVIRONMENT' | 'OPEN_DOOR'>> {}
}
